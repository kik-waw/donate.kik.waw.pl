...
const Languages = () => <>
    <LanguageSwitcher lang='en'>In English</LanguageSwitcher>{" / "}
    <LanguageSwitcher lang='pl'>po polsku</LanguageSwitcher>{" / "}
    <LanguageSwitcher lang='de'>auf Detusch</LanguageSwitcher>
</>
                ...
                <div className="mt-6 max-w-4xl sm:w-full">
                    <div className="flex flex-row justify-center sm:flex-column">
                        ...
                        <div className="w-1/2 text-justify">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque vehicula pellentesque
                            placerat. Fusce dapibus suscipit facilisis. Nulla vestibulum lorem eu dolor ultrices
                            dapibus. Integer vel cursus felis, id rutrum tortor. Integer dignissim fermentum vestibulum.
                            Quisque condimentum condimentum ligula vel gravida. Cras quis sagittis elit, nec commodo
                            ligula. Praesent a quam lorem. Integer fringilla ipsum ut metus convallis condimentum.
                            Nullam rhoncus turpis vitae tortor placerat elementum. Sed ut ante nec dui dictum eleifend.
                            Suspendisse at rhoncus lacus, at venenatis purus. Cras faucibus a sapien ac fermentum.
